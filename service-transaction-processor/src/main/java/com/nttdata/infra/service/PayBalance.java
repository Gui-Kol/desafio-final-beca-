...
public class PayBalance {
    ...
    public PayBalance(Faild faild, Completed completed, MockApi mockApi) {
        this.faild = faild;
    ...
    public void withdrawal(Transaction transaction, BankDto sourceBank) {
        var transactionValue = transaction.getValue().doubleValue();
    ...
    public void deposit(Transaction transaction, BankDto sourceBank, BankDto destinationBank) {
        var transactionValue = transaction.getValue().doubleValue();
